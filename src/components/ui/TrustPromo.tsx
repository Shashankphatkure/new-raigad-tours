...
import { Clock, GraduationCap, MapPin, Shield, Tag, Users } from "lucide-react";
...
const LEFT_TRUST_ITEMS = [
  ...
  { icon: MapPin, value: "Maharashtra", label: "& Beyond" },
  { icon: Users, value: "Schools &", label: "Groups" },
  { icon: GraduationCap, value: "Educational", label: "Travel" },
];

/**
 * Cross-page trust promo, placed just above the footer on every page.
 * Split card: credentials + copy on white, a photo with a simple, static
 * fact block on the other side — no counters, no invented figures.
 */
        ...
        <div className="grid grid-cols-1 overflow-hidden rounded-card shadow-soft lg:grid-cols-[60fr_40fr]">
          ...
          <div className="flex flex-col justify-center bg-white p-10 sm:p-12 lg:p-14">
            <h2 className="font-display text-h2 leading-tight text-brown">
              Travel Designed
              <span className="block text-forest">for Schools & Groups.</span>
            </h2>
          ...
          {/* Right — photo with a simple, static fact block */}
          <div className="relative min-h-[420px] lg:min-h-[560px]">
            ...
            <div className="relative flex h-full flex-col justify-center gap-4 p-8 sm:p-10">
              ...
              <p className="font-display text-h2 leading-tight text-cream">
                For Schools & Groups
              </p>
              <p className="text-body text-cream/80">
                Educational Travel · Direct Trip Support
              </p>
            </div>
          </div>
        </div>
