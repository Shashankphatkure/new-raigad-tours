...
export const DESTINATIONS: Destination[] = [
  {
    ...
    name: "Mumbai",
    region: "Maharashtra",
    title: "Gateway City: Heritage, Science & the Harbour",
    description:
      "Colonial architecture and the working harbour paired with hands-on science at the Nehru Centre and planetarium — history, urban geography and astronomy in one city.",
    duration: "2 Days",
    highlights: [
      "Gateway of India",
    ...
    grades: "Grades 4–12",
    tripType: "Historical",
    image: "/images/maharashtra/mumbai.png",
    imageAlt: "Aerial view of the Gateway of India and Marine Drive shoreline in Mumbai",
  ...
  },
  {
    ...
    name: "Mahabaleshwar",
    region: "Maharashtra",
    title: "Plateau Farms, Forts & Viewpoints",
    description:
      "Strawberry farms and Mapro's processing line for a hands-on agriculture lesson, paired with Pratapgad Fort's Maratha history and the plateau's mountain viewpoints.",
    duration: "3 Days",
    highlights: [
      "Pratapgad Fort",
      "Venna Lake",
    ...
    grades: "Grades 5–12",
    tripType: "Nature",
    image: "/images/maharashtra/mahabaleshwar.jpg",
    imageAlt: "Misty green mountains of the Western Ghats near Mahabaleshwar",
  ...
  },
  {
    ...
    name: "Raigad Fort",
    region: "Maharashtra",
    title: "Capital of the Maratha Empire",
    description:
      "Shivaji Maharaj's hill capital, reached by ropeway, read through its fortified gateway, the Samadhi and the ruined royal court as a lesson in medieval military strategy and administration.",
    duration: "2 Days",
    highlights: [
      "Raigad Fort",
      "Maha Darwaja",
    ...
    grades: "Grades 6–12",
    tripType: "Historical",
    image: "/images/maharashtra/raigad-fort.png",
    imageAlt: "The fortified stone stairway and ramparts of Raigad Fort along a Sahyadri ridge",
    coordinates: { lat: 18.2406, lng: 73.44 },
    point: { x: 213, y: 678 },
    labelOffset: { dx: -40, dy: -6 },
    labelAnchor: "end",
  },
  {
    id: "ajanta-ellora",
  ...
  },
  {
    ...
    name: "Hyderabad",
    region: "Telangana",
    title: "Deccan Capital: History, Science & Cinema",
    description:
      "Qutb Shahi architecture at Golconda and Charminar, a science afternoon at Birla Science Centre, and a look behind the scenes at Ramoji Film City — Deccan history, art and media in one city.",
    duration: "4 Days",
    highlights: [
      "Charminar",
      "Golconda Fort",
  ...
  },
  {
    ...
    name: "Warangal",
    region: "Telangana",
    title: "Kakatiya Stone Carving & Temple Architecture",
    description:
      "The Kakatiya dynasty's fortified capital, its thousand carved pillars and the UNESCO-listed Ramappa Temple, read together as a lesson in medieval Deccan stone architecture.",
    duration: "2 Days",
    highlights: [
      "Warangal Fort",
    ...
    grades: "Grades 6–12",
    tripType: "Historical",
    image: "/images/telangana/warangal.png",
    imageAlt:
      "The carved stone gateway of Kakatiya Kala Thoranam flanked by elephant statues at Warangal Fort",
  ...
  },
  {
    ...
    region: "Telangana",
    title: "Dam Engineering & Buddhist Archaeology",
    description:
      "One of the world's tallest masonry dams studied alongside Nagarjunakonda's island museum of Buddhist sculpture, reached by boat across the Krishna reservoir.",
    duration: "2 Days",
    highlights: [
      "Nagarjuna Sagar Dam",
      "Nagarjunakonda",
    ...
    grades: "Grades 6–12",
    tripType: "Historical",
    image: "/images/telangana/nagarjuna-sagar.png",
    imageAlt: "A monolithic Buddha statue rising from a lake at dusk, city lights in the distance",
    coordinates: { lat: 16.5738, lng: 79.3122 },
    point: { x: 397, y: 739 },
    labelOffset: { dx: 20, dy: 26 },
    labelAnchor: "start",
  },
  {
    id: "bhadrachalam",
    name: "Bhadrachalam",
    region: "Telangana",
    title: "Temple Town on the Godavari",
    description:
      "The Sri Sita Ramachandraswamy Temple above the Godavari, read alongside Parnasala's Ramayana associations and the river landscapes and tribal communities of the Bhadradri region.",
    duration: "2 Days",
    highlights: [
    ...
    grades: "Grades 5–12",
    tripType: "Historical",
    image: "/images/telangana/bhadrachalam.png",
    imageAlt:
      "The white temple towers of Sri Sita Ramachandraswamy Temple overlooking the Godavari River at Bhadrachalam",
    coordinates: { lat: 17.6688, lng: 80.8934 },
    point: { x: 447, y: 699 },
